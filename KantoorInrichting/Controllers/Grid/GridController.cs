...
namespace KantoorInrichting.Controllers.Grid
{
    public class GridController : IController
    {
        ...
        public void Dispose(object sender, EventArgs e)
        {
            ...
            ((CheckBox) _view.Get("Checkbox")).Checked = false;
        }
...
//        /// <param name="e"></param>
        public void Resize(object sender, EventArgs e)
        {
            ...
            {
                Bitmap newBuffer = new Bitmap(_panel.Width,
                    _panel.Height);
                ...
                if (_buffer != null)
                {
                    ...
                    {
                        bufferGraphics.DrawImageUnscaled(_buffer,
                            Point.Empty);
                    }
                }
        ...
        {
            _rectangle.Size = new Size(_trackBar.Value,
                _trackBar.Value);
        }
