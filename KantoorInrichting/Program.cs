...
namespace KantoorInrichting {
    class Program {
        ...
        static void Main()
        {
            ...
            ProductModel p1 = new ProductModel("stoel henk", "Ahrend", "A1", "koek", "jodenkoek",  140, 40, 40,"hele fijne stoel",0);
            //ProductModel p2 = new ProductModel("stoel piet",  "Ahrend", "B1", null, null, 140, 40, 40, "hele fijne stoel", 124);
            ...
            //ProductModel p6 = new ProductModel("prullenbak harrie", "Ahrend", "243A3431", null, null, 100, 140, 40, "hele fijne prullenbak", 124);
            ...
            CategoryManagerController catman = new CategoryManagerController(p1);
            Console.WriteLine("koek: " + p1.category);
            Console.WriteLine("jodenkoek: " + p1.subcategory);
        }
    }
}
